        ...
        <div class="py-8">
            <div class="grid grid-cols-2 md:grid-cols-2 gap-8">
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-300">Contato: {{ $about->contact ?? 'MCImóveis' }}</p>
                    <p class="text-gray-300">Tel: {{ $about?->phone ?? '(21) 2523-5959' }}</p>
                    <p class="text-gray-300">Email: {{ $about?->email ?? 'contato@mcImóveis.com.br' }}</p>
                </div>
                <div class="text-center">
            ...
            <div class="border-t border-gray-700 mt-8 pt-8 text-center">
                <p class="text-gray-300">&copy; {{ date('Y') }} {{ $about?->enterprise_name ?? 'MCImóveis' }}. Todos os direitos reservados.</p>
            </div>
        </div>
    </div>
</footer>
