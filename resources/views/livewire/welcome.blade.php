    ...
    <section class="container relative z-20 px-4 mx-auto -mt-12 mb-12">
        <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
            <div class="flex flex-col items-center p-6 text-center bg-white rounded-xl shadow-lg gap-2">
                <h3 class="mb-2 text-lg font-bold">+30 ANOS DE EXPERIÊNCIA</h3>
                ...
                <p class="text-gray-600 mt-2">Com mais de 30 anos de experiência no mercado imobiliário, construindo uma trajetória de confiança e excelência, expandindo nossa expertise com projetos na Itália.</p>
            </div>
            <div class="flex flex-col items-center p-6 text-center bg-white rounded-xl shadow-lg gap-2">
            ...
            <div class="flex flex-col items-center p-6 text-center bg-white rounded-xl shadow-lg gap-2">
                ...
                <a href="https://wa.me/5521981366864" target="_blank" class="inline-flex items-center px-6 py-2 mt-4 font-semibold text-white bg-primary rounded-lg transition hover:bg-secondary">
